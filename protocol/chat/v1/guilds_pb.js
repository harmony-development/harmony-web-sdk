...
goog.exportSymbol('proto.protocol.chat.v1.UpdateGuildNameRequest', null, global);
/**
 ...
 * @constructor
 */
proto.protocol.chat.v1.UpdateGuildNameRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.protocol.chat.v1.UpdateGuildNameRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.protocol.chat.v1.UpdateGuildNameRequest.displayName = 'proto.protocol.chat.v1.UpdateGuildNameRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.protocol.chat.v1.UpdateGuildNameRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.protocol.chat.v1.UpdateGuildNameRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    guildId: jspb.Message.getFieldWithDefault(msg, 1, "0"),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.protocol.chat.v1.UpdateGuildNameRequest}
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.protocol.chat.v1.UpdateGuildNameRequest;
  return proto.protocol.chat.v1.UpdateGuildNameRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.protocol.chat.v1.UpdateGuildNameRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.protocol.chat.v1.UpdateGuildNameRequest}
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.protocol.chat.v1.UpdateGuildNameRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.protocol.chat.v1.UpdateGuildNameRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGuildId();
  if (parseInt(f, 10) !== 0) {
    writer.writeUint64String(
 ...
 * @return {string}
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.prototype.getGuildId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.protocol.chat.v1.UpdateGuildNameRequest} returns this
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.prototype.setGuildId = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.prototype.getNewGuildName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.protocol.chat.v1.UpdateGuildNameRequest} returns this
 */
proto.protocol.chat.v1.UpdateGuildNameRequest.prototype.setNewGuildName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
