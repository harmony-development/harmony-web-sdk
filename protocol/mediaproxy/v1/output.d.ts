  ...
  namespace mediaproxy {
    ...
    namespace v1 {
      ...
      class MediaMetadata implements IMediaMetadata {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: protocol.mediaproxy.v1.IMediaMetadata);
        ...
        /**
         * Encodes the specified MediaMetadata message. Does not implicitly {@link protocol.mediaproxy.v1.MediaMetadata.verify|verify} messages.
         * @param message MediaMetadata message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(
          message: protocol.mediaproxy.v1.IMediaMetadata,
          writer?: $protobuf.Writer
        ): $protobuf.Writer;
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number
        ): protocol.mediaproxy.v1.MediaMetadata;
         ...
         */
        public static toObject(
          message: protocol.mediaproxy.v1.MediaMetadata,
          options?: $protobuf.IConversionOptions
        ): { [k: string]: any };
      ...
      /** Properties of a FetchLinkMetadataResponse. */
      interface IFetchLinkMetadataResponse {
        /** FetchLinkMetadataResponse isSite */
        isSite?: protocol.mediaproxy.v1.ISiteMetadata | null;

        /** FetchLinkMetadataResponse isMedia */
        isMedia?: protocol.mediaproxy.v1.IMediaMetadata | null;
      }

      /** Represents a FetchLinkMetadataResponse. */
      class FetchLinkMetadataResponse implements IFetchLinkMetadataResponse {
        /**
         * Constructs a new FetchLinkMetadataResponse.
         * @param [properties] Properties to set
         */
        constructor(
          properties?: protocol.mediaproxy.v1.IFetchLinkMetadataResponse
        );

        /** FetchLinkMetadataResponse isSite. */
        public isSite?: protocol.mediaproxy.v1.ISiteMetadata | null;

        /** FetchLinkMetadataResponse isMedia. */
        public isMedia?: protocol.mediaproxy.v1.IMediaMetadata | null;

        /** FetchLinkMetadataResponse data. */
        public data?: "isSite" | "isMedia";

        /**
         * Encodes the specified FetchLinkMetadataResponse message. Does not implicitly {@link protocol.mediaproxy.v1.FetchLinkMetadataResponse.verify|verify} messages.
         * @param message FetchLinkMetadataResponse message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(
          message: protocol.mediaproxy.v1.IFetchLinkMetadataResponse,
          writer?: $protobuf.Writer
        ): $protobuf.Writer;

        /**
         * Decodes a FetchLinkMetadataResponse message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns FetchLinkMetadataResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number
        ): protocol.mediaproxy.v1.FetchLinkMetadataResponse;

        /**
         * Creates a FetchLinkMetadataResponse message from a plain object. Also converts values to their respective internal types.
         * @param object Plain object
         * @returns FetchLinkMetadataResponse
         */
        public static fromObject(object: {
        ...
        /**
         * Creates a plain object from a FetchLinkMetadataResponse message. Also converts values to other types if specified.
         * @param message FetchLinkMetadataResponse
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(
          message: protocol.mediaproxy.v1.FetchLinkMetadataResponse,
          options?: $protobuf.IConversionOptions
        ): { [k: string]: any };

        /**
         * Converts this FetchLinkMetadataResponse to JSON.
         * @returns JSON object
         */
        public toJSON(): { [k: string]: any };
      }
      ...
      class MediaProxyService extends $protobuf.rpc.Service {
         ...
         * @param callback Node-style callback called with the error, if any, and FetchLinkMetadataResponse
         */
        ...
        public fetchLinkMetadata(
          request: protocol.mediaproxy.v1.IFetchLinkMetadataRequest
        ): Promise<protocol.mediaproxy.v1.FetchLinkMetadataResponse>;
      ...
      namespace MediaProxyService {
         ...
         * @param [response] FetchLinkMetadataResponse
         */
        type FetchLinkMetadataCallback = (
          error: Error | null,
          response?: protocol.mediaproxy.v1.FetchLinkMetadataResponse
        ) => void;
