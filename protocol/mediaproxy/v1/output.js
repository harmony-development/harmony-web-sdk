...
$root.protocol = (function() {
    ...
    protocol.mediaproxy = (function() {
        ...
        mediaproxy.v1 = (function() {
            ...
            v1.MediaMetadata = (function() {

                function MediaMetadata(properties) {
                    if (properties)
                        for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                            if (properties[keys[i]] != null)
                                this[keys[i]] = properties[keys[i]];
                ...
                MediaMetadata.prototype.mimetype = "";
                MediaMetadata.prototype.filename = "";

                MediaMetadata.encode = function encode(message, writer) {
                    if (!writer)
                        writer = $Writer.create();
                ...
                MediaMetadata.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.mediaproxy.v1.MediaMetadata();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                MediaMetadata.fromObject = function fromObject(object) {
                    if (object instanceof $root.protocol.mediaproxy.v1.MediaMetadata)
                        return object;
                    var message = new $root.protocol.mediaproxy.v1.MediaMetadata();
                ...
                MediaMetadata.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    var object = {};
                    if (options.defaults) {
                ...
                MediaMetadata.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
            ...
            v1.FetchLinkMetadataResponse = (function() {

                function FetchLinkMetadataResponse(properties) {
                    if (properties)
                        for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                            if (properties[keys[i]] != null)
                                this[keys[i]] = properties[keys[i]];
                ...
                FetchLinkMetadataResponse.prototype.isSite = null;
                FetchLinkMetadataResponse.prototype.isMedia = null;

                var $oneOfFields;

                Object.defineProperty(FetchLinkMetadataResponse.prototype, "data", {
                    get: $util.oneOfGetter($oneOfFields = ["isSite", "isMedia"]),
                    set: $util.oneOfSetter($oneOfFields)
                });

                FetchLinkMetadataResponse.encode = function encode(message, writer) {
                    if (!writer)
                        writer = $Writer.create();
                    if (message.isSite != null && Object.hasOwnProperty.call(message, "isSite"))
                        $root.protocol.mediaproxy.v1.SiteMetadata.encode(message.isSite, writer.uint32(10).fork()).ldelim();
                    if (message.isMedia != null && Object.hasOwnProperty.call(message, "isMedia"))
                        $root.protocol.mediaproxy.v1.MediaMetadata.encode(message.isMedia, writer.uint32(18).fork()).ldelim();
                    return writer;
                };

                FetchLinkMetadataResponse.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.mediaproxy.v1.FetchLinkMetadataResponse();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                            message.isSite = $root.protocol.mediaproxy.v1.SiteMetadata.decode(reader, reader.uint32());
                            break;
                        case 2:
                            message.isMedia = $root.protocol.mediaproxy.v1.MediaMetadata.decode(reader, reader.uint32());
                            break;
                        default:
                            reader.skipType(tag & 7);
                            break;
                ...
                FetchLinkMetadataResponse.fromObject = function fromObject(object) {
                    if (object instanceof $root.protocol.mediaproxy.v1.FetchLinkMetadataResponse)
                        return object;
                    var message = new $root.protocol.mediaproxy.v1.FetchLinkMetadataResponse();
                    if (object.isSite != null) {
                        if (typeof object.isSite !== "object")
                            throw TypeError(".protocol.mediaproxy.v1.FetchLinkMetadataResponse.isSite: object expected");
                        message.isSite = $root.protocol.mediaproxy.v1.SiteMetadata.fromObject(object.isSite);
                    }
                    if (object.isMedia != null) {
                        if (typeof object.isMedia !== "object")
                            throw TypeError(".protocol.mediaproxy.v1.FetchLinkMetadataResponse.isMedia: object expected");
                        message.isMedia = $root.protocol.mediaproxy.v1.MediaMetadata.fromObject(object.isMedia);
                    }
                    return message;
                };

                FetchLinkMetadataResponse.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    var object = {};
                    if (message.isSite != null && message.hasOwnProperty("isSite")) {
                        object.isSite = $root.protocol.mediaproxy.v1.SiteMetadata.toObject(message.isSite, options);
                        if (options.oneofs)
                            object.data = "isSite";
                    }
                    if (message.isMedia != null && message.hasOwnProperty("isMedia")) {
                        object.isMedia = $root.protocol.mediaproxy.v1.MediaMetadata.toObject(message.isMedia, options);
                        if (options.oneofs)
                            object.data = "isMedia";
                    }
                    return object;
                ...
                FetchLinkMetadataResponse.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };

                return FetchLinkMetadataResponse;
            })();
            ...
            v1.MediaProxyService = (function() {
                ...
                Object.defineProperty(MediaProxyService.prototype.fetchLinkMetadata = function fetchLinkMetadata(request, callback) {
                    return this.rpcCall(fetchLinkMetadata, $root.protocol.mediaproxy.v1.FetchLinkMetadataRequest, $root.protocol.mediaproxy.v1.FetchLinkMetadataResponse, request, callback);
