...
goog.exportSymbol('proto.protocol.foundation.v1.GetConfigResponse', null, global);
 ...
 * @constructor
 */
proto.protocol.foundation.v1.GetConfigResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.protocol.foundation.v1.GetConfigResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.protocol.foundation.v1.GetConfigResponse.displayName = 'proto.protocol.foundation.v1.GetConfigResponse';
}
 ...
 * @return {!Object}
 */
proto.protocol.foundation.v1.GetConfigResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.protocol.foundation.v1.GetConfigResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.protocol.foundation.v1.GetConfigResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protocol.foundation.v1.GetConfigResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.protocol.foundation.v1.GetConfigResponse}
 */
proto.protocol.foundation.v1.GetConfigResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.protocol.foundation.v1.GetConfigResponse;
  return proto.protocol.foundation.v1.GetConfigResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.protocol.foundation.v1.GetConfigResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.protocol.foundation.v1.GetConfigResponse}
 */
proto.protocol.foundation.v1.GetConfigResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.protocol.foundation.v1.GetConfigResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.protocol.foundation.v1.GetConfigResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.protocol.foundation.v1.GetConfigResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protocol.foundation.v1.GetConfigResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.protocol.foundation.v1.GetConfigResponse.prototype.getRequire2fa = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.protocol.foundation.v1.GetConfigResponse} returns this
 */
proto.protocol.foundation.v1.GetConfigResponse.prototype.setRequire2fa = function(value) {
