...
proto.protocol.foundation.v1.LoginRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.protocol.foundation.v1.LoginRequest.Federated.serializeBinaryToWriter);
    }
    f = message.getLocal();
    if (f != null) {
        writer.writeMessage(2, f, proto.protocol.foundation.v1.LoginRequest.Local.serializeBinaryToWriter);
    }
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
...
proto.protocol.foundation.v1.LoginRequest.prototype.getFederated = function () {
    return /** @type{?proto.protocol.foundation.v1.LoginRequest.Federated} */ (jspb.Message.getWrapperField(this, proto.protocol.foundation.v1.LoginRequest.Federated, 1));
};
/**
...
proto.protocol.foundation.v1.LoginRequest.prototype.getLocal = function () {
    return /** @type{?proto.protocol.foundation.v1.LoginRequest.Local} */ (jspb.Message.getWrapperField(this, proto.protocol.foundation.v1.LoginRequest.Local, 2));
};
/**
...
//# sourceMappingURL=foundation_pb.js.map