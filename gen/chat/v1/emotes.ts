...
/**
 * @generated from protobuf message protocol.chat.v1.EmotePack
 */
...
/**
 * @generated from protobuf message protocol.chat.v1.Emote
 */
...
export interface GetEmotePacksResponse {
    /**
     * @generated from protobuf field: repeated protocol.chat.v1.EmotePack packs = 1;
     */
    packs: EmotePack[];
}
/**
...
export interface GetEmotePackEmotesResponse {
    /**
     * @generated from protobuf field: repeated protocol.chat.v1.Emote emotes = 1;
     */
    emotes: Emote[];
}
/**
...
/**
 * Type for protobuf message protocol.chat.v1.EmotePack
 */
class EmotePack$Type extends MessageType<EmotePack> {
    constructor() {
        super("protocol.chat.v1.EmotePack", [
...
/**
 * Type for protobuf message protocol.chat.v1.Emote
 */
class Emote$Type extends MessageType<Emote> {
    constructor() {
        super("protocol.chat.v1.Emote", [
