...
import type { QueryHasPermissionResponse } from "./permissions";
import type { QueryHasPermissionRequest } from "./permissions";
...
export class ChatServiceClient implements IChatServiceClient, ServiceInfo {
    ...
    queryHasPermission(input: QueryHasPermissionRequest, options?: RpcOptions): UnaryCall<QueryHasPermissionRequest, QueryHasPermissionResponse> {
        ...
        return stackIntercept<QueryHasPermissionRequest, QueryHasPermissionResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Endpoint to set permissions for a role in a guild.
     *
