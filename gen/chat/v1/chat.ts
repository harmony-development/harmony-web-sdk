...
export const ChatService = new ServiceType("protocol.chat.v1.ChatService", [
    ...
    { name: "DeleteGuild", options: { "protocol.harmonytypes.v1.metadata": { requiresAuthentication: true, requiresPermissionNode: "guild.manage.delete" } }, I: DeleteGuildRequest, O: DeleteGuildResponse },
    ...
    { name: "QueryHasPermission", options: { "protocol.harmonytypes.v1.metadata": { requiresAuthentication: true } }, I: QueryHasPermissionRequest, O: QueryHasPermissionResponse },
