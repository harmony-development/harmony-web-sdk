...
export interface Profile {
     ...
     *
     * @deprecated
     * @generated from protobuf field: bool is_bot = 4 [deprecated = true];
     */
    isBot: boolean;
    /**
     * what kind of account the user is, e.g. full, guest, bot.
     *
     * @generated from protobuf field: protocol.profile.v1.AccountKind account_kind = 5;
     */
...
class Profile$Type extends MessageType<Profile> {
    constructor() {
        super("protocol.profile.v1.Profile", [
            ...
            { no: 5, name: "account_kind", kind: "enum", T: () => ["protocol.profile.v1.AccountKind", AccountKind, "ACCOUNT_KIND_"] }
        ]);
    }
}
/**
